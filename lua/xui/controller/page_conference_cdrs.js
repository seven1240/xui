	...
	render () {
		...
		return <div>
			...
			<div>
				...
				<tbody>
				<tr>
					<th><T.span text="Number" onClick={() => this.handleSortClick('caller_id_name')} className="cursor-hand"/></th>
					<th><T.span text="Name" onClick={() => this.handleSortClick('caller_id_number')} className="cursor-hand"/></th>
			...
			</div>
			{
				...
				<ConferenceCDRPage show={this.state.formShow} onHide={formClose} cdr={this.state.cdr}/>
			}
		</div>
	}
};
