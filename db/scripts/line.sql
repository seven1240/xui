...
update line set start_station = (select stat_name from station where line_code = line.line_code and station_order = (select max(station_order) from station where line_code = line.line_code) limit 1);
