LANGUAGES["zh"] = {
	...
	"Add Member(s)": "添加用户",
	"Select Groups": "选择用户组",
	"In order to add group members": "按顺序添加组成员",
	"Select All": "全选",
	...
	"Delete the group members": "删除整组成员",
	"Confirm to clear the group members?": "确认清除所有成员吗？",
	"Clear the group": "删除该组成员",
	...
	"Confirm to Reset ?": "确认重置？",
	"New Key": "申请Key",
	"Reset Key": "重置Key",
	"Delete Key": "删除Key",
	"Confirm to Close?": "确认关闭？",
	"Confirm to hang up chosen members?": "该操作会挂掉您选择的成员，是否继续？",
	"Can't Delete Because The Child Group Exist!": "不能删除因为子组还在!",
