...
import { DevicePage, DevicesPage } from './page_devices';
		...
		return <Router history={hashHistory}>
			<Route path="/" component={App}>
				...
				<Route path="settings">
					...
					<Route path="devices">
						<IndexRoute components={{sidebar: Settings, main: DevicesPage}}/>
						<Route path=":id" components={{sidebar: Settings, main: DevicePage}}/>
					</Route>
